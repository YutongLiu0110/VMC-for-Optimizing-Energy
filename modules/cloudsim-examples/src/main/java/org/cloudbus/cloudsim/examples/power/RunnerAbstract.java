...
public abstract class RunnerAbstract {
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		} else if (vmAllocationPolicyName.equals("m")) {
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationM(
					hostList,
					vmSelectionPolicy,
					parameter);

		} else if (vmAllocationPolicyName.equals("multi")) {
			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					hostList,
					vmSelectionPolicy,
					0.7);
			vmAllocationPolicy = new PowerVMAllocationPolicyMigrationMulti(
					hostList,
					vmSelectionPolicy,
					parameter, //最大可容忍能耗
					fallbackVmSelectionPolicy);
	...
	protected PowerVmSelectionPolicy getVmSelectionPolicy(String vmSelectionPolicyName) {
		...
		} else if (vmSelectionPolicyName.equals("cmu")) {
			vmSelectionPolicy = new PowerVMSelectionPolicyCMU(
					new PowerVmSelectionPolicyMinimumMigrationTime()
			);
